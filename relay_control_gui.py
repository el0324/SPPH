...
def log_relay(run: str, delay: float|None, relay: str, start, end) -> None:
...
#=============================== Sensor Code: ================================#
def format_sensor_data(data) -> None:
  global selected_run
  global relay_open
  global sensor_val
  global sensor_status_text
...
def sensor_status_update():
  ...
  sensor_status = Label(WIN, text=sensor_status_text, font=REGULAR_FONT, 
                        bg=sensor_text_bd, anchor='nw')
  sensor_status_window = MY_CANVAS.create_window(700, 55, anchor = 'nw', 
